...
export interface DocumentSnapshotExists<T> extends firebase.firestore.DocumentData {
...
export interface QueryDocumentSnapshot<T> extends firebase.firestore.DocumentData {
    data(options?: SnapshotOptions): T;
}
export interface QuerySnapshot<T> extends firebase.firestore.DocumentData {
    readonly docs: QueryDocumentSnapshot<T>[];
}
export interface DocumentChange<T> extends firebase.firestore.DocumentData {
